...
<html lang="es" dir="ltr">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    <div class="container-fluid">
      ...
      <a class="navbar-brand ms-5" href="index.php"><img src="images/logo.png" width="30" height="30" class="d-inline-block align-top" alt="">&nbspSimulador COVID-19</a>
  ...
  <body>
  	<div class="row">
  		<div class="col-sm-12">
              ...
              <a href="recuperar_contraseña.php" style="text-decoration: none; float: right; color: #34495e;" data-toggle="tooltip" title="Recuperar Contraseña">Recuperar contraseña</a><br><br>
  						<center><input type = "submit" value ="Iniciar Sesión" name = "login" class="btn  btn-lg btn-outline-dark" /></center>
  						<?php
