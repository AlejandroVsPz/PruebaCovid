    ...
    <div class="row">
 		<div class="col-sm-12">
 			<div class="main-content">
 				<div class="header">
 					<h3 style="text-align: center; font-family: 'Arial'; letter-spacing: 1pt;" id="h3"><strong>Editar Contraseña</strong></h3>
 				</div>
 				<div class="l-part">
            ...
            <label for='nombre' class='form-label'>Contraseña Anterior</label>
 						<div class="input-group">
 							<input type="password" name="last_password" class="form-control" placeholder="Contraseña Anterior" required="required">
 						</div><br>
            <label for='nombre' class='form-label'>Contraseña Nueva</label>
            <div class="input-group">
 							<input type="password" name="new_password" class="form-control" placeholder="Contraseña Nueva" required="required">
 						</div><br>
            <label for='nombre' class='form-label'>Confirmar Contraseña</label>
 						<div class="input-group">
 							<input type="password" name="confirm_password" class="form-control" placeholder="Confirmar Contraseña" required="required">
 						</div><br>

 						<center><input type = "submit" value ="Guardar Contraseña" name="submit" class="btn btn-outline-dark btn-lg"></center>
